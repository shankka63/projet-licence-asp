...
namespace WebApplication1
{
    public class NotesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NoteId,Matiere,Appreciation,DateNote,Notation,EleveId")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NoteId,Matiere,Appreciation,DateNote,Notation,EleveId")] Note note)
        {
            if (ModelState.IsValid)
            {
